...
namespace W3C.CCG.DidCore.X25519
{
    public class Curve25519
    {
        ...
        /// <summary>
        /// Creates a deterministic private key from seed
        /// </summary>
        /// <returns>32 random bytes that are clamped to a suitable private key</returns>
        public static byte[] CreateRandomPrivateKey(string seed)
        {
            var privateKey = SHA256.Create().ComputeHash(Encoding.UTF8.GetBytes(seed));
            ClampPrivateKeyInline(privateKey);
